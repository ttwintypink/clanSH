...
@tree.command(
    ...
    description_localizations={"ru": "Привязать канал, куда бот будет публиковать события регистрации"},
)
...
@tree.command(
    ...
    name_localizations={"ru": "событие"},
    description_localizations={"ru": "Создать событие регистрации (все шаги придут в ЛС)"},
)
